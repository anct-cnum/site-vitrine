  ...
  return (
    <div className="fr-grid-row fr-grid-row--gutter">
      ...
      <div className="fr-col-10 fr-mb-9w">
        <h4 className="h4CustomKit" id="titre-ancre-6">6.&nbsp;&nbsp;Ressources pour accompagner les Conseillers num&eacute;riques dans leurs missions</h4>
        <h4 className="h4CustomKit h4CustomKit--secondary" id="titre-ancre-6.1">
