  ...
  return (
    <div className="fr-grid-row fr-grid-row--gutter">
      ...
      <div className="fr-col-10 fr-col-md-8 fr-mb-7w">
        <h4 className="h4CustomKit h4CustomKit--secondary" id="titre-ancre-3.1">3.1&nbsp;&nbsp;Plaquette de pr&eacute;sentation du dispositif CnFS</h4>
        <p style={{ marginBottom: '24px' }}>
          ...
          France Services de mani&egrave;re synth&eacute;tique. Il s&rsquo;agit d&rsquo;un format A4 recto verso imprimable.
        ...
        <p style={{ marginBottom: '24px' }}>
          <a
            href="https://cdn.conseiller-numerique.gouv.fr/kit-communication/V3/plaquette-cnfs-pour-edition.zip"
        ...
        <p style={{ marginBottom: '24px' }}>
          <a
            href="https://cdn.conseiller-numerique.gouv.fr/kit-communication/V3/modele-pre-rempli-plaquette-cnfs.pdf"
        ...
        <p style={{ marginBottom: '0' }}>
          <a
            href="https://cdn.conseiller-numerique.gouv.fr/kit-communication/V3/assemblage-InDesign-plaquette-cnfs.zip"
      ...
      <div className="fr-col-12 fr-col-md-2 fr-mb-7w fr-mb-md-0w preview-image">
        <img
          src="https://cdn.conseiller-numerique.gouv.fr/kit-communication/V3/previews/previews-plaquette-cnfs.png"
