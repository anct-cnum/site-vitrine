  ...
  return (
    <div className="fr-grid-row fr-grid-row--gutter">
      ...
      <div className="fr-col-10 fr-col-md-8 fr-mb-9w">
        <h4 className="h4CustomKit h4CustomKit--secondary" id="titre-ancre-2.5">2.5&nbsp;&nbsp;Illustrations</h4>
        ...
        <p style={{ marginBottom: '0px' }}>
          <a
            href="https://cdn.conseiller-numerique.gouv.fr/kit-communication/V3/pack-illustrations.zip"
            title="Pack illustrations"
            className="bleu-france"
            style={{ boxShadow: 'none' }}
            target="_blank"
            rel="noopener noreferrer">T&eacute;l&eacute;chargez le pack d&rsquo;illustrations Conseiller num&eacute;rique France Services.</a>
        </p>
      </div>
      <div className="fr-col-12 fr-col-md-2 fr-mb-7w fr-mb-md-0w preview-image">
        <img
          src="https://cdn.conseiller-numerique.gouv.fr/kit-communication/V3/previews/preview-illus.png"
