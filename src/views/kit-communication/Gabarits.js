  ...
  return (
    <div className="fr-grid-row fr-grid-row--gutter">
      ...
      <div className="fr-col-10 fr-col-md-8 fr-mb-7w">
        <h4 className="h4CustomKit h4CustomKit--secondary" id="titre-ancre-3.2">3.2&nbsp;&nbsp;Gabarits pour les r&eacute;seaux sociaux</h4>
        ...
        <p style={{ marginBottom: '0px' }}>
          <a
            href="https://cdn.conseiller-numerique.gouv.fr/kit-communication/V3/gabarits-reseaux-sociaux.zip"
      ...
      <div className="fr-col-12 fr-col-md-2 fr-mb-7w fr-mb-md-0w preview-image">
        <img
          src="https://cdn.conseiller-numerique.gouv.fr/kit-communication/V3/previews/preview-gabarits-rs.png"
