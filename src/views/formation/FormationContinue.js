...
function FormationContinue() {
  ...
  const regleDeSuiviFormationContinueUrl = `${import.meta.env.VITE_APP_AIDE_URL}/article/formation-continue-obligatoire-combien-de-modules-thematiques-doit-suivre-un-conseiller-numerique-1e3zehu/`;
  return (
