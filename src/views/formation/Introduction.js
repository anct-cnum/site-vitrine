  ...
  return (
    <>
      <div className="fr-col-offset-2 fr-col-10">
        <h1 className="fr-h1 fr-mt-10w fr-mb-5w">Formation des conseillers num&eacute;riques</h1>
      </div>
      <div className="fr-col-offset-2 fr-col-10 introduction">
          En 2024, la formation des conseiller num&eacute;riques reprend et s&rsquo;enrichit&nbsp;!
      </div>
