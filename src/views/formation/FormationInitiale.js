    ...
    <div className="fr-col-9 fr-mt-3w cadre">
      ...
      <div className="fr-ml-5w fr-col-11">
        <p>
          ...
          capacit&eacute; &agrave; accompagner des publics divers vers l&rsquo;autonomie num&eacute;rique, est le point final de votre formation initiale.
        </p>
        <p>
          Pour vous y pr&eacute;parer, trois parcours de formation vous sont propos&eacute;s : 70h (court), 175h (interm&eacute;diaire)
          ou 315h (long). Un test de positionnement, en deux temps, sera organis&eacute; pour identifier le parcours le plus ad&eacute;quat
          &agrave; vos besoins :
          <ul>
            <li>
            ...
            <li>
              Vous passerez ensuite un entretien avec une &eacute;quipe de l&rsquo;organisme de formation, o&ugrave; vous aurez
              l&rsquo;occasion de discuter ensemble des r&eacute;sultats du test en ligne, et de revenir sur votre exp&eacute;rience
              professionnelle et vos motivations. A la fin de l&rsquo;entretien, un petit temps d&rsquo;&eacute;change pourra &ecirc;tre
              pr&eacute;vu avec votre structure d&rsquo;accueil pour pr&eacute;senter le d&eacute;roul&eacute; de la formation, en fonction
              du parcours choisi.
            </li>
          </ul>
        </p>
